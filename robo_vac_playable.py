...
def play():
    ...
    while not clean:
        ...
        pygame.draw.rect(env.background, black, (10, 10, 260, 120))
        ...
        if env.calc_clean_percent() >= .9 or passed_time / 1000 >= 300:
            print('Game Over. It took you ' + str(round(passed_time / 1000, 2)) + ' seconds to clean ' +
                  str(env.calc_clean_percent() * 100) + '%!')
            clean = True
